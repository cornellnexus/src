...
def main():
    ...
    if activation_type == "rectangle":
        ...
        nodes = activate_rectangle(
            nodes, rec_row_start, rec_col_start, rec_row_limit, rec_col_limit
        )
        border_nodes, _, leftmost_node_pos, nodes = find_border_nodes(nodes)
        way_points = get_all_lawnmower_waypoints_adjustable(
            nodes, leftmost_node_pos, border_nodes
        )
    ...
    if activation_type == "circle":
        ...
        nodes = activate_circle(
            nodes, circle_center_row, circle_center_col, circle_radius
        )
        border_nodes, _, leftmost_node_pos, nodes = find_border_nodes(nodes)
        way_points = get_all_lawnmower_waypoints_adjustable(
            nodes, leftmost_node_pos, border_nodes
