...
def traverse_straight_line(
    ...
    r2d2_state = Robot_State(
        ...
        motor_controller=MotorController(10, 0.016275, 0.016275, 5, 5, True),
    )  # By pass execute_setup
...
def one_node_straight_line(long, lat, err):
    ...
    """
    r2d2_state = Robot_State(
        xpos=0, ypos=0, heading=math.pi / 2, epsilon=0.2, max_velocity=0.2, radius=5
    )
