...
class MissionTest:
    def __init__(self):
        ...
        self.mission_state = Mission_State(
            robot=self.r2d2,
            base_station_coord=self.r2d2_base.coord,
    ...
    def test_traverse(self):
        self.r2d2.execute_traversal(
            self.mission.waypoints_to_visit,
            self.mission.allowed_dist_error,
            self.mission.base_station_loc,
            self.mission.control_mode,
            self.mission.time_limit,
            self.mission.roomba_radius,
            self.database,
        )
    ...
    def test_avoid_obstacle(self):
        ...
        self.r2d2.execute_avoid_obstacle(
            self.mission.waypoints_to_visit,
            self.mission.allowed_dist_error,
            self.mission.base_station_loc,
            self.mission.control_mode,
    ...
    def test_return(self):
        self.r2d2.execute_return(
            self.mission.base_station_loc,
            self.mission.base_station_angle,
            self.mission.allowed_docking_pos_error,
            self.mission.allowed_heading_error,
            self.database,
        )
