...
def graph_traversal_path(g, map_name, distance_type, mode=ControlMode.LAWNMOWER_FULL):
    """
...
class TestGrid(unittest.TestCase):
    def test_borders_mode(self):
        count = 0
        g = Grid(42.444250, 42.444599, -76.483682, -76.483276)
        full_waypoints = g.get_waypoints(ControlMode.LAWNMOWER_FULL)
        ...
        border_waypoints = g.get_waypoints(ControlMode.LAWNMOWER_BORDERS)
