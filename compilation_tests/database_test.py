...
class TestDataBase(unittest.TestCase):
    ...
    db_initial = DataBase(2, [10, 20, 50], is_sim=False, time_step=.2, weight=2, battery=98,
    ...
    db_one_param = DataBase(weight=3, battery=46, acceleration=[0.5, 0.2, 0.3])
    ...
    def test_get_data(self):
        ...
        db_params = [(0, "phase"), ([0, 0, 0], "state"), (True, "is_sim"), (0.1, "time_step"), (0, "weight"),
        ...
        db_initial_params = [(2, "phase"), ([10, 20, 50], "state"), (False, "is_sim"), (0.2, "time_step"),
                             (2, "weight"),
        ...
        db_one_params = [(0, "phase"), ([0, 0, 0], "state"), (True, "is_sim"), (0.1, "time_step"), (3, "weight"),
    ...
    def test_update_data(self):
        ...
        db_new_params = [(1, "phase"), ([3, 5, 20], "state"), (False, "is_sim"), (0.1, "time_step"), (0, "weight"),
                         (0, "battery"), (0.5, "move_dist"), ([0, 0, 0], "acceleration"),
                         ([0, 0, 0], "magnetic_field"), ([0, 0, 0], "gyro_rotation"),
                         ([0, 0, 0], "position_pid"), (0, "position_noise"), ([0, 0, 0], "heading_pid")
                         ]

        db_initial_new_params = [(2, "phase"), ([10, 20, 50], "state"), (False, "is_sim"), (0.7, "time_step"),
                                 (2, "weight"),
                                 (98, "battery"), (0.6, "move_dist"), ([4.25, 3.2, 0.1], "acceleration"),
        ...
        db_one_new_params = [(3, "phase"), ([0, 0, 0], "state"), (True, "is_sim"), (0.1, "time_step"), (3, "weight"),
