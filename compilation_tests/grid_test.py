...
def graph_traversal_path(g, map_name, distance_type, mode='lawn_full'):
    """
...
class VisualizeGrid(unittest.TestCase):
    ...
    def test_engineering_quad(self):
        ...
        graph_traversal_path(g, 'Engineering Quad', 'Vincenty', 'lawn_full')
    #
    def test_paul_mansion(self):
        g = Grid(42.444250, 42.444599, -76.483682, -76.483276)
        graph_traversal_path(g, 'Paul Mansion', 'Vincenty', 'spiral')

    def test_paul_backyard(self):
        g = Grid(42.444250, 42.444599, -76.483682, -76.483276)
        graph_traversal_path(g, 'Paul Backyard', 'Vincenty', 'lawn_border')
...
class TestGrid(unittest.TestCase):
    def test_borders_mode(self):
        count = 0
        g = Grid(42.444250, 42.444599, -76.483682, -76.483276)
        full_waypoints = g.get_waypoints('lawn_full')
        ...
        border_waypoints = g.get_waypoints('lawn_border')
