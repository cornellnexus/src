...
import compilation_tests.traversal_test as traversal_test
...
# adding tests:
compilation_tests = [node_test, pid_controller_test, state_manager_test, robot_test, kinematics_test, traversal_test]
