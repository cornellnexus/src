...
class LocalizationEKF:
    ...
    def __init__(self, init_mu, init_sigma, robot_width):
        ...
        self.R = np.array([[5, 0, 0], [0, 5, 0], [0, 0, 5]])  # measurement noise matrix
    ...
    def get_g_jac(pose, control):
        ...
        if phi == 0:
            ...
            y_t = [
                0,
                1,
                -d / phi * (-math.sin(theta_prev + phi) + math.sin(theta_prev)),
            ]
    ...
    def get_controls(self, arc_lengths):
        ...
        try:
            turn_radius = (
                left_side_arc_length
                * self.robot_width
                / (right_side_arc_length - left_side_arc_length)
            )
        except:
            turn_radius = 0
