...
class Transmittor:
    ...
    def rmi(self):
        ...
        return json.dumps({
            ...
            "sensors": {
                "gps": {
                    "connected": self.robot_state.gps_connected,
                    # Assuming this method returns a dictionary or list
                    "reading": self.robot_state.gps.get_gps()
                },
                "imu": {
                    "connected": self.robot_state.imu_connected,
                    # Assuming this method returns a dictionary or list
                    "reading": self.robot_state.imu.get_imu()
                },
                # "break_beams": { ... },  # Skipped for brevity
                "wheel_motors": {
                    "duty_cycle": self.robot_state.motor_controller.dc,
                    "linear_velocity": self.robot_state.linear_v,
                    "left_wheel_velocity": self.robot_state.motorcontroller.left_right_angular_vel(self.robot_state.angular_v, self.robot_state.linear_v)[0],
            ...
            "battery": {
                "battery_percent": self.robot_state.battery,
                "time_until_recharge": "00:00:00",  # TODO: Replace with actual value
                "low_power_mode": False  # TODO: Replace with actual value
            },
            "metrics": {
                "goal_loc": {
                    "global_coord": self.robot_state.goal_location,  # TODO: Replace with actual value
                    "local_coord": self.robot_state.goal_location,  # TODO: Replace with actual value
                    "robot_goal_dist": 0  # TODO: Replace with actual value
                },
                "state": {
                    # TODO: Replace with actual value
                    "global_coord": self.robot_state.state[0],
                    # TODO: Replace with actual value
                    "local_coord": self.robot_state.state[0],
                    "heading": self.robot_state.state[1]
                },  # End of state
                "phase": self.robot_state.phase,
                "eta_to_base": "00:00:00",  # TODO: Replace with actual value
                "goal_nodes_completed": 0,  # TODO: Replace with actual value
                "eta_complete": "00:00:00"  # TODO: Replace with actual value
            }  # End of metrics
    ...
    def make_packet(self):
        # Get data from rmi
        rmi_data = self.rmi()
        # Create a PacketRMI instance
        packet = Packet(rmi_data)
