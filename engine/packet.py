...
#         s = str_vals[i]
#         if i == len(str_vals) - 1:
#             formatted_str += fix_data_size(s,
#                                            desired_int_length, desired_decimal_length)
#         else:
#             formatted_str += fix_data_size(s, desired_int_length,
...
#                 (";batt:", fix_data_size(self.batt +
#                  ".0", 3, -1)), (";ctrl:", self.ctrl)
#                 ]
...
class Packet:
    def __init__(self, rmi_data):
        # This assumes rmi_data is the dictionary returned by rmi()
        self.data = rmi_data
    ...
    @classmethod
    def deserialize(cls, packet_string):
