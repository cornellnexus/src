...
class BaseStation:
    ...
    def __init__(
        self, coord, grid, heading=math.pi / 2, battery=None, plastic_load=None
    ):
        """
        Arguments:
        ...
        """
        self.coord = coord
        x = get_vincenty_x((grid.lat_min, grid.long_min), coord)
        y = get_vincenty_y((grid.lat_min, grid.long_min), coord)
        self.position = (x, y)
